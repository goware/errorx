...
// verbositySubset returns a subset of Errorx fields, depending on verbosity,
// allowing only a part of the error to be marshaled to JSON
...
// getTrace generates trace for Errorx
